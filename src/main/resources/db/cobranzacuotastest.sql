...
--
-- Servidor: localhost
-- Tiempo de generación: 29-06-2022 a las 14:26:42
...
(49, '2022-06-29 13:07:22', '2022-06-29', 'Alta Sucursal 27 por usuario: administrador', 11),
(50, '2022-06-29 13:42:22', '2022-06-29', 'Alta Sucursal 28 por usuario: administrador', 11),
(51, '2022-06-29 13:42:50', '2022-06-29', 'Alta Sucursal 29 por usuario: administrador', 11),
(52, '2022-06-29 13:52:27', '2022-06-29', 'Alta Cliente 59 por usuario: secretario1', 12),
(53, '2022-06-29 13:55:15', '2022-06-29', 'Alta proveedor 12 por usuario: administrador', 11),
(54, '2022-06-29 13:55:53', '2022-06-29', 'Alta plan de pago 68 por usuario: secretario1', 12),
(55, '2022-06-29 13:57:01', '2022-06-29', 'Recibo ID: 28, generado con éxito', 12);
...
(59, 'Juan Perez', '34111222', 1, 936, '', '', '', '', '', '', 'Sarmiento 123', 1, 1);
...
(158, 0, 0, 0, 59),
(159, 19792.8, 0, 19792.8, 59),
(160, 0, 3298.8, 16494, 59);
...
(817, 1, 1, 12000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2022-07-29', 0),
(818, 2, 1, 11000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2022-08-29', 0),
(819, 3, 0, 10000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2022-09-29', 1649.4),
(820, 4, 0, 9000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2022-10-29', 1649.4),
(821, 5, 0, 8000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2022-11-29', 1649.4),
(822, 6, 0, 7000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2022-12-29', 1649.4),
(823, 7, 0, 6000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2023-01-29', 1649.4),
(824, 8, 0, 5000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2023-03-01', 1649.4),
(825, 9, 0, 4000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2023-03-29', 1649.4),
(826, 10, 0, 3000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2023-04-29', 1649.4),
(827, 11, 0, 2000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2023-05-29', 1649.4),
(828, 12, 0, 1000, 0, 0, 44.4, 1000, 480, 1649.4, 68, 0, 0, 125, '2023-06-29', 1649.4);
...
(6, '20123456780', 'Test', '0123456789', '5cdf6e5d-3eaf-470e-b127-a7105ac4fcfc_logo.jpg', 1, '2022-06-29', 'Estudio Test');
...
(156, 1649.4, '2022-06-29', 817, 'Cancela cuota nro: 1', 1),
(157, 1649.4, '2022-06-29', 818, 'Cancela cuota nro: 2', 1);
...
(68, '2022-06-29', '19792.8', '12', 1649.4, NULL, 1, 12000, 4, 125, 3, 0, 0, 12, 1, 0, 0, 'Dr. Señor X', '1000/22');
...
(12, 'Credibel', 'Güemes 352', '', '', '3624808080', '', 'credibelrcia@gmail.com', '', 429, 6, 1, '20371234564');
...
(28, 'RECIBIMOS (TRES MIL DOSCIENTOS NOVENTA Y OCHO PESOS CON OCHENTA CENTAVOS)', 1);
...
(27, 'Av. Italia 123', '3624123456', '', '3624234567', '', 'sucursal1@gmail.com', '', 1, 122, 1, 6, 429, 'Sucursal Central'),
(28, 'Av. San Martin 2550', '', '', '', '', '', '', 0, 350, 1, 6, 936, 'Sucursal Goya'),
(29, 'Av. Italia 1200', '', '', '', '', '', '', 0, 777, 1, 6, 1246, 'Sucursal Clorinda');
...
(16, 'administrador', 'administrador', '2022-06-29', 5, '1234', '$2a$10$dubD.KHfvivoKGG7InP1E.r3PawA1/dj3YLo.O55u5a6d6NBXsiue', 1),
(17, 'test', 'test', '2022-06-29', 4, 'San Martin', '$2a$10$je39BP5uCtCMLg0rheGBye8jEcTqel6SJZNzl8EYMdYhX9PaOHznG', 1),
(18, 'secretario1', 'secretario1', '2022-06-29', 4, 'San Martin', '$2a$10$tvmJSOP.MSXgT1Pkq6DzuuESPfEUiLkJwWJrn3PysrVS/kqb3vD8.', 1);
...
--
ALTER TABLE `actividades_usuarios`
  MODIFY `id_actividad` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `clientes`
  MODIFY `id_cliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `ctasctescliente`
  MODIFY `id_ctactecliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;

--
-- AUTO_INCREMENT de la tabla `cuotas`
--
ALTER TABLE `cuotas`
  MODIFY `id_cuota` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=829;

--
-- AUTO_INCREMENT de la tabla `detalles_recibos`
--
ALTER TABLE `detalles_recibos`
  MODIFY `id_detalle_recibo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `historiales_altas_clientes`
  MODIFY `id_historial_cliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `historiales_altas_planes_pagos`
--
ALTER TABLE `historiales_altas_planes_pagos`
  MODIFY `id_historial_alta_plan_pago` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `historiales_proveedores`
--
ALTER TABLE `historiales_proveedores`
  MODIFY `id_historial_proveedor` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `historiales_recibos`
--
ALTER TABLE `historiales_recibos`
  MODIFY `id_historial_recibo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `historiales_sucursales`
--
ALTER TABLE `historiales_sucursales`
  MODIFY `id_historial_sucursal` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `importes`
--
ALTER TABLE `importes`
  MODIFY `id_importe` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;
...
--
ALTER TABLE `planes_pagos`
  MODIFY `id_plan_pago` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `recibos`
  MODIFY `id_recibo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `sucursales`
  MODIFY `id_sucursal` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `usuarios_sucursales`
  MODIFY `id_usuario_sucursal` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
