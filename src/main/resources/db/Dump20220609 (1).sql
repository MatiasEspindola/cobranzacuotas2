...
INSERT INTO `authorities` VALUES (1,1,1);
...
INSERT INTO `clientes` VALUES (49,'Espindola Matias','39752709',1,429,'3624428509','','3624117976','','maatiasespindola@gmail.com','','779 GABARDINI',1);
...
INSERT INTO `ctasctescliente` VALUES (127,'2022-05-31',0,0,0),(128,'2022-06-01',19792.8,0,19792.8),(129,'2022-05-31',0,4948.2,14844.6),(130,'2022-05-31',0,1000,13844.6);
...
INSERT INTO `detalles_recibos` VALUES (50,19,137),(51,19,138),(52,19,139),(53,19,140),(54,20,141);
...
INSERT INTO `empresas` VALUES (1,'20123456780','Test','0800-111-222','139d1bf7-3a0e-4afa-9f0f-fa49cea13c86_logo2.jpg',1,429,NULL);
...
INSERT INTO `importes` VALUES (137,1649.4,'2022-05-31',661,'Cancela cuota nro: 1',1),(138,1649.4,'2022-05-31',662,'Cancela cuota nro: 2',1),(139,701.2,'2022-05-31',663,'Abona parcialmente cuota nro: 3',1),(140,948.2,'2022-05-31',663,'Cancela cuota nro: 3',2),(141,1000,'2022-05-31',664,'Abona parcialmente cuota nro: 4',2);
...
CREATE TABLE `planes_pagos` (
  ...
  CONSTRAINT `id_sucursal` FOREIGN KEY (`id_sucursal`) REFERENCES `sucursales` (`id_sucursal`),
...
INSERT INTO `planes_pagos` VALUES (56,'2022-06-01','19792.8','12',1649.4,NULL,1,12000,4,125,3,0,0,1,1,0,0,'-','1000/22',49,NULL);
...
INSERT INTO `proveedores` VALUES (1,'Credibel','Av. Chaco 123','3624428509','','3624112233','','credibel@gmail.com','',429,1,1,'12345678'),(2,'Fravega','Av. Castelli 189','3624123456','','3625114747','','fravega@gmail.com','',429,6,1,'38764888');
...
INSERT INTO `recibos` VALUES (19,'RECIBIMOS (CUATRO MIL NOVECIENTOS CUARENTA Y OCHO PESOS CON VEINTE CENTAVOS)',1),(20,'RECIBIMOS (MIL PESOS)',1);
...
INSERT INTO `roles` VALUES (1,'Administrador'),(2,'Sucursal');
...
INSERT INTO `usuarios` VALUES (1,_binary '','12345','administrador','2022-04-14',NULL,NULL,'$2a$10$SqG.4aMY6CDxop8pVUZFmu4eFOnSECI.jbfLXzx8ZdLW2PUd5teCC',NULL,NULL);
...
-- Dump completed on 2022-06-09 16:17:31
