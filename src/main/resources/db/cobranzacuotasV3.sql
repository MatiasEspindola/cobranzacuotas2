...
--
-- Servidor: localhost
-- Tiempo de generación: 15-06-2022 a las 15:40:45
...
--
ALTER TABLE `clientes`
  MODIFY `id_cliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `ctasctescliente`
  MODIFY `id_ctactecliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
...
--
ALTER TABLE `historiales_altas_clientes`
  MODIFY `id_historial_cliente` int NOT NULL AUTO_INCREMENT;
