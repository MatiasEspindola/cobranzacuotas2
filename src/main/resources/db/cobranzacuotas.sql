CREATE DATABASE  IF NOT EXISTS `desarrollocuotas` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `desarrollocuotas`;
-- MySQL dump 10.13  Distrib 8.0.25, for Win64 (x86_64)
--
-- Host: localhost    Database: desarrollocuotas
-- ------------------------------------------------------
...
INSERT  IGNORE INTO `authorities` VALUES (1,1,1);
...
INSERT  IGNORE INTO `clientes` VALUES (49,'Espindola Matias','39752709',1,'2022-05-31',429,'3624428509','','3624117976','','maatiasespindola@gmail.com','','779 GABARDINI',1);
...
CREATE TABLE `comprobantes` (
  ...
  CONSTRAINT `id_tipo_comprobante` FOREIGN KEY (`id_tipo_comprobante`) REFERENCES `tipos_comprobantes` (`id_tipo_comprobante`)
...
INSERT  IGNORE INTO `comprobantes` VALUES (6,'TRANSPORTE/12',7),(7,'PLAN_PAGO/12',8),(8,'TRANSPORTE/13',7),(9,'PLAN_PAGO/16',8),(10,'TRANSPORTE/14',7),(11,'PLAN_PAGO/18',8),(12,'PLAN_PAGO/19',8),(13,'TRANSPORTE/15',7),(14,'PLAN_PAGO/20',8),(15,'PLAN_PAGO/21',8),(16,'TRANSPORTE/17',7),(17,'TRANSPORTE/18',7),(18,'PLAN_PAGO/22',8),(19,'TRANSPORTE/19',7),(20,'PLAN_PAGO/23',8),(21,'PLAN_PAGO/24',8),(22,'TRANSPORTE/20',7),(23,'TRANSPORTE/21',7),(24,'PLAN_PAGO/25',8),(25,'TRANSPORTE/22',7),(26,'PLAN_PAGO/26',8),(27,'TRANSPORTE/23',7),(28,'PLAN_PAGO/27',8),(29,'TRANSPORTE/24',7),(30,'PLAN_PAGO/28',8),(31,'TRANSPORTE/25',7),(32,'PLAN_PAGO/29',8),(33,'TRANSPORTE/26',7),(34,'PLAN_PAGO/30',8),(35,'TRANSPORTE/27',7),(36,'PLAN_PAGO/31',8),(37,'TRANSPORTE/28',7),(38,'PLAN_PAGO/32',8),(39,'TRANSPORTE/29',7),(40,'PLAN_PAGO/33',8),(41,'RECIBO/33',9),(42,'RECIBO/33',9),(43,'RECIBO/33',9),(44,'RECIBO/33',9),(45,'TRANSPORTE/30',7),(46,'PLAN_PAGO/34',8),(47,'RECIBO/34',9),(48,'RECIBO/34',9),(49,'TRANSPORTE/31',7),(50,'PLAN_PAGO/35',8),(51,'TRANSPORTE/32',7),(52,'PLAN_PAGO/36',8),(53,'RECIBO/36',9),(54,'RECIBO/36',9),(55,'RECIBO/36',9),(56,'RECIBO/36',9),(57,'RECIBO/36',9),(58,'TRANSPORTE/33',7),(59,'PLAN_PAGO/37',8),(60,'RECIBO/37',9),(61,'RECIBO/37',9),(62,'RECIBO/37',9),(63,'RECIBO/37',9),(64,'RECIBO/37',9),(65,'RECIBO/37',9),(66,'RECIBO/37',9),(67,'RECIBO/37',9),(68,'RECIBO/37',9),(69,'RECIBO/37',9),(70,'TRANSPORTE/34',7),(71,'PLAN_PAGO/38',8),(72,'RECIBO/38',9),(73,'RECIBO/38',9),(74,'RECIBO/38',9),(75,'TRANSPORTE/35',7),(76,'PLAN_PAGO/39',8),(77,'TRANSPORTE/36',7),(78,'PLAN_PAGO/40',8),(79,'PLAN_PAGO/41',8),(80,'TRANSPORTE/37',7),(81,'PLAN_PAGO/42',8),(82,'TRANSPORTE/38',7),(83,'PLAN_PAGO/43',8),(84,'TRANSPORTE/39',7),(85,'PLAN_PAGO/44',8),(86,'TRANSPORTE/40',7),(87,'PLAN_PAGO/45',8),(88,'RECIBO/84/1',9),(89,'RECIBO/85/2',9),(90,'RECIBO/86/2',9),(91,'RECIBO/87/3',9),(92,'TRANSPORTE/41',7),(93,'PLAN_PAGO/46',8),(94,'RECIBO/88/1',9),(95,'RECIBO/89/2',9),(96,'RECIBO/90/2',9),(97,'RECIBO/91/3',9),(98,'RECIBO/92/4',9),(99,'RECIBO/93/5',9),(100,'RECIBO/94/6',9),(101,'RECIBO/95/7',9),(102,'RECIBO/96/7',9),(103,'RECIBO/97/7',9),(104,'RECIBO/98/8',9),(105,'TRANSPORTE/42',7),(106,'PLAN_PAGO/47',8),(107,'RECIBO/99/1',9),(108,'RECIBO/100/2',9),(109,'RECIBO/101/2',9),(110,'RECIBO/102/2',9),(111,'RECIBO/103/3',9),(112,'RECIBO/104/3',9),(113,'TRANSPORTE/43',7),(114,'PLAN_PAGO/48',8),(115,'RECIBO/11',9),(116,'TRANSPORTE/44',7),(117,'PLAN_PAGO/49',8),(118,'RECIBO/12',9),(119,'RECIBO/13',9),(120,'PLAN_PAGO/50',8),(121,'PLAN_PAGO/51',8),(122,'TRANSPORTE/45',7),(123,'PLAN_PAGO/52',8),(124,'RECIBO/14',9),(125,'TRANSPORTE/46',7),(126,'PLAN_PAGO/53',8),(127,'RECIBO/15',9),(128,'RECIBO/16',9),(129,'RECIBO/17',9),(130,'RECIBO/18',9),(131,'TRANSPORTE/46',7),(132,'TRANSPORTE/49',7),(133,'PLAN_PAGO/56',8),(134,'RECIBO/19',9),(135,'RECIBO/20',9);
...
INSERT  IGNORE INTO `conceptos` VALUES (1,'COBRANZA');
...
CREATE TABLE `ctasctescliente` (
  ...
  CONSTRAINT `id_cli` FOREIGN KEY (`id_cli`) REFERENCES `clientes` (`id_cliente`),
  CONSTRAINT `id_comprobante` FOREIGN KEY (`id_comprobante`) REFERENCES `comprobantes` (`id_comprobante`)
...
INSERT  IGNORE INTO `ctasctescliente` VALUES (127,'2022-05-31',0,0,0,49,132),(128,'2022-06-01',19792.8,0,19792.8,49,133),(129,'2022-05-31',0,4948.2,14844.6,49,134),(130,'2022-05-31',0,1000,13844.6,49,135);
...
INSERT  IGNORE INTO `cuotas` VALUES (661,1,1,12000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2022-07-01',0),(662,2,1,11000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2022-08-01',0),(663,3,1,10000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2022-09-01',0),(664,4,0,9000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2022-10-01',649.4),(665,5,0,8000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2022-11-01',1649.4),(666,6,0,7000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2022-12-01',1649.4),(667,7,0,6000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2023-01-01',1649.4),(668,8,0,5000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2023-02-01',1649.4),(669,9,0,4000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2023-03-01',1649.4),(670,10,0,3000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2023-04-01',1649.4),(671,11,0,2000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2023-05-01',1649.4),(672,12,0,1000,0,0,44.4,1000,480,1649.4,56,0,0,125,'2023-06-01',1649.4);
...
INSERT  IGNORE INTO `detalles_recibos` VALUES (50,19,137),(51,19,138),(52,19,139),(53,19,140),(54,20,141);
...
CREATE TABLE `empresas` (
  ...
  `mail` varchar(255) DEFAULT NULL,
  `mail2` varchar(255) DEFAULT NULL,
  `puntoventaafipcentral` int DEFAULT NULL,
...
INSERT  IGNORE INTO `empresas` VALUES (1,'20123456780','Estudio Jurídico Test','Test','Liniers 1543','0800-111-222','139d1bf7-3a0e-4afa-9f0f-fa49cea13c86_logo2.jpg',1,'3624428509','3624111111','3624117976','3624731319','estudio1@gmail.com','',128,429,'2020-05-19');
...
INSERT  IGNORE INTO `importes` VALUES (137,1649.4,'2022-05-31',661,'Cancela cuota nro: 1',1),(138,1649.4,'2022-05-31',662,'Cancela cuota nro: 2',1),(139,701.2,'2022-05-31',663,'Abona parcialmente cuota nro: 3',1),(140,948.2,'2022-05-31',663,'Cancela cuota nro: 3',2),(141,1000,'2022-05-31',664,'Abona parcialmente cuota nro: 4',2);
...
INSERT  IGNORE INTO `medios_pagos` VALUES (1,'2022-05-05','Efectivo',1),(2,'2022-05-05','Transferencia',2);
...
INSERT  IGNORE INTO `planes_pagos` VALUES (56,'2022-06-01','19792.8','12',1649.4,NULL,1,12000,4,125,3,0,0,1,1,0,0,1,'-','1000/22',49);
...
INSERT  IGNORE INTO `proveedores` VALUES (1,'Credibel','Av. Chaco 123','3624428509','','3624112233','','credibel@gmail.com','',429,1,1,'12345678'),(2,'Fravega','Av. Castelli 189','3624123456','','3625114747','','fravega@gmail.com','',429,6,1,'38764888');
...
CREATE TABLE `recibos` (
  ...
  `id_ctactecli` int DEFAULT NULL,
  `id_concepto` int DEFAULT NULL,
  PRIMARY KEY (`id_recibo`),
  KEY `id_ctactecli` (`id_ctactecli`),
  KEY `id_concepto` (`id_concepto`),
  CONSTRAINT `id_concepto` FOREIGN KEY (`id_concepto`) REFERENCES `conceptos` (`id_concepto`),
  CONSTRAINT `id_ctactecli` FOREIGN KEY (`id_ctactecli`) REFERENCES `ctasctescliente` (`id_ctactecliente`)
...
INSERT  IGNORE INTO `recibos` VALUES (19,'2022-05-31 14:30:42','2022-05-31','RECIBIMOS (CUATRO MIL NOVECIENTOS CUARENTA Y OCHO PESOS CON VEINTE CENTAVOS)',NULL,1),(20,'2022-05-31 14:36:07','2022-05-31','RECIBIMOS (MIL PESOS)',NULL,1);
...
INSERT  IGNORE INTO `roles` VALUES (1,'Administrador'),(2,'Sucursal');
...
INSERT  IGNORE INTO `tipos_comprobantes` VALUES (7,'TRANSPORTE'),(8,'PLAN_PAGO'),(9,'RECIBO');
...
INSERT  IGNORE INTO `tipos_documentos` VALUES (1,'D.N.I.'),(2,'L.C.'),(3,'L.E.'),(4,'C.I.'),(5,'CUIL'),(6,'CUIT');
...
INSERT  IGNORE INTO `tipos_intereses` VALUES (1,'Interés Fijo'),(2,'Interés Sobre Saldos');
...
CREATE TABLE `usuarios` (
  ...
  `mail` varchar(255) DEFAULT NULL,
  `mail2` varchar(255) DEFAULT NULL,
  `id_empresa_user` int DEFAULT NULL,
  `password` varchar(255) NOT NULL,
  PRIMARY KEY (`id_usuario`),
  KEY `id_empresa_user` (`id_empresa_user`),
  CONSTRAINT `id_empresa_user` FOREIGN KEY (`id_empresa_user`) REFERENCES `empresas` (`id_empresa`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT  IGNORE INTO `usuarios` VALUES (1,_binary '','12345','administrador','2022-04-14',NULL,NULL,1,'$2a$10$SqG.4aMY6CDxop8pVUZFmu4eFOnSECI.jbfLXzx8ZdLW2PUd5teCC');
...
-- Dump completed on 2022-06-09 14:32:18
