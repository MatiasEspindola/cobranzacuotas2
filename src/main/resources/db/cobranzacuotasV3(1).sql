...
--
-- Servidor: localhost
-- Tiempo de generación: 16-06-2022 a las 14:24:39
...
--
-- Base de datos: `cobranzacuotasV3`
--
...
(4, 11, '2022-06-16 14:04:19', '2022-06-16', 'Alta Cliente Juan Perez por usuario: administrador');
...
(51, 'Juan Perez', '38752666', 1, 429, '3624808080', '', '3624585088', '', '', '', 'Güemes 350', 1, 1);
...
INSERT INTO `ctasctescliente` (`id_ctactecliente`, `fecha`, `debe`, `haber`, `saldo`) VALUES
(131, '2022-06-16', 0, 0, 0),
(132, '2022-06-16', 0, 0, 0),
(133, '2022-06-16', 0, 0, 0),
(134, '2022-06-16', 0, 0, 0);
...
INSERT INTO `historiales_altas_clientes` (`id_historial_cliente`, `id_ctactecliente_cliente`, `fk_cliente`, `descripcion`, `alta`, `id_actividad_cliente`) VALUES
(3, 134, 51, 'TRANSPORTE CLI/51', NULL, 4);
...
(3, 'Credibel', 'Don Bosco 250', '3624808080', '', '3624178950', '', '', '', 429, 6, 1, '17361234564'),
(4, 'Fravega', 'Jujuy 128', '', '', '', '', '', '', 429, 6, 1, '25214566544');
...
INSERT INTO `sucursales` (`id_sucursal`, `direccion`, `tel_fijo`, `tel_fijo2`, `cel`, `cel2`, `mail`, `mail2`, `es_casa_central`, `puntoventaafip`, `activo`, `id_empresa`, `id_usuario`, `id_localidad2`) VALUES
(14, 'Av. Italia 123', '3624428509', '3624428510', '3624117913', '3624731319', 'sucursal1@gmail.com', 'sucursal1@hotmail.com', 0, 127, 1, 2, 11, 429);
...
--
ALTER TABLE `clientes`
  MODIFY `id_cliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `ctasctescliente`
  MODIFY `id_ctactecliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;

--
-- AUTO_INCREMENT de la tabla `cuotas`
--
ALTER TABLE `cuotas`
  MODIFY `id_cuota` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=673;

--
-- AUTO_INCREMENT de la tabla `detalles_recibos`
--
ALTER TABLE `detalles_recibos`
  MODIFY `id_detalle_recibo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `historiales_altas_clientes`
  MODIFY `id_historial_cliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `historiales_altas_planes_pagos`
--
ALTER TABLE `historiales_altas_planes_pagos`
  MODIFY `id_historial_alta_plan_pago` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `historiales_recibos`
--
ALTER TABLE `historiales_recibos`
  MODIFY `id_historial_recibo` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `importes`
--
ALTER TABLE `importes`
  MODIFY `id_importe` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;
...
--
ALTER TABLE `planes_pagos`
  MODIFY `id_plan_pago` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `recibos`
  MODIFY `id_recibo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `sucursales`
  MODIFY `id_sucursal` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `historiales_altas_clientes`
  ADD CONSTRAINT `fk_cliente` FOREIGN KEY (`fk_cliente`) REFERENCES `clientes` (`id_cliente`),
...
ALTER TABLE `planes_pagos`
  ...
  ADD CONSTRAINT `id_sucursal` FOREIGN KEY (`id_sucursal`) REFERENCES `sucursales` (`id_sucursal`),
