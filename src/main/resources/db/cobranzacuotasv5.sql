...
--
-- Host: localhost    Database: cobranzacuotasv1p1
-- ------------------------------------------------------
...
CREATE TABLE `actividades_usuarios` (
  ...
  KEY `id_us` (`id_us`),
  CONSTRAINT `id_us` FOREIGN KEY (`id_us`) REFERENCES `usuarios` (`id_usuario`)
...
INSERT INTO `actividades_usuarios` VALUES (13,11,'2022-06-20 19:29:04','2022-06-20','Alta proveedor 8 por usuario: administrador'),(14,11,'2022-06-20 19:34:47','2022-06-20','Alta Cliente 53 por usuario: administrador'),(15,11,'2022-06-20 22:04:24','2022-06-20','Alta plan de pago 58 por usuario: administrador');
...
CREATE TABLE `authorities` (
  ...
  KEY `id_rol_auth` (`id_rol_auth`),
  CONSTRAINT `id_rol_auth` FOREIGN KEY (`id_rol_auth`) REFERENCES `roles` (`id_rol`),
  CONSTRAINT `id_usuario_auth` FOREIGN KEY (`id_usuario_auth`) REFERENCES `usuarios` (`id_usuario`)
...
INSERT INTO `authorities` VALUES (7,10,3),(8,11,1);
...
CREATE TABLE `clientes` (
  ...
  KEY `id_localidad1` (`id_localidad1`),
  KEY `id_responsable1` (`id_responsable1`),
  CONSTRAINT `id_localidad1` FOREIGN KEY (`id_localidad1`) REFERENCES `localidades` (`id`),
  CONSTRAINT `id_responsable1` FOREIGN KEY (`id_responsable1`) REFERENCES `responsables_iva` (`id_responsable`),
  CONSTRAINT `id_tipo_documento` FOREIGN KEY (`id_tipo_documento`) REFERENCES `tipos_documentos` (`id_tipo_documento`)
...
INSERT INTO `clientes` VALUES (53,'Juan Cruz Toledo','39752709',1,429,'3624428509','','3624117976','','maatiasespindola@gmail.com','','Liniers 580',1,1);
...
INSERT INTO `conceptos` VALUES (1,'COBRANZA');
/*!40000 ALTER TABLE `conceptos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ctasctescliente`
--

DROP TABLE IF EXISTS `ctasctescliente`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ctasctescliente` (
  `id_ctactecliente` int NOT NULL AUTO_INCREMENT,
  `debe` float NOT NULL,
  `haber` float NOT NULL,
  `saldo` float NOT NULL,
  `id_cliente` int DEFAULT NULL,
  PRIMARY KEY (`id_ctactecliente`),
...
--
-- Dumping data for table `ctasctescliente`
--

LOCK TABLES `ctasctescliente` WRITE;
/*!40000 ALTER TABLE `ctasctescliente` DISABLE KEYS */;
INSERT INTO `ctasctescliente` VALUES (136,0,0,0,53),(137,19792.8,0,19792.8,53);
/*!40000 ALTER TABLE `ctasctescliente` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cuotas` (
  ...
  KEY `id_plan_pago` (`id_plan_pago`),
  CONSTRAINT `id_plan_pago` FOREIGN KEY (`id_plan_pago`) REFERENCES `planes_pagos` (`id_plan_pago`)
...
INSERT INTO `cuotas` VALUES (685,1,0,12000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2022-07-20',1649.4),(686,2,0,11000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2022-08-20',1649.4),(687,3,0,10000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2022-09-20',1649.4),(688,4,0,9000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2022-10-20',1649.4),(689,5,0,8000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2022-11-20',1649.4),(690,6,0,7000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2022-12-20',1649.4),(691,7,0,6000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2023-01-20',1649.4),(692,8,0,5000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2023-02-20',1649.4),(693,9,0,4000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2023-03-20',1649.4),(694,10,0,3000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2023-04-20',1649.4),(695,11,0,2000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2023-05-20',1649.4),(696,12,0,1000,0,0,44.4,1000,480,1649.4,58,0,0,125,'2023-06-20',1649.4);
/*!40000 ALTER TABLE `cuotas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `detalles_recibos`
--

DROP TABLE IF EXISTS `detalles_recibos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `detalles_recibos` (
  ...
  KEY `id_importe` (`id_importe`),
  CONSTRAINT `id_importe` FOREIGN KEY (`id_importe`) REFERENCES `importes` (`id_importe`),
  CONSTRAINT `id_recibo` FOREIGN KEY (`id_recibo`) REFERENCES `recibos` (`id_recibo`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `detalles_recibos`
--

LOCK TABLES `detalles_recibos` WRITE;
/*!40000 ALTER TABLE `detalles_recibos` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalles_recibos` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `empresas` (
  ...
  CONSTRAINT `id_responsable` FOREIGN KEY (`id_responsable`) REFERENCES `responsables_iva` (`id_responsable`)
...
INSERT INTO `empresas` VALUES (2,'20123456780','Custidiano','0800-111-222','b32c22cb-6f4f-4397-8f8f-60fbf01ed997_logo.jpg',1,'2022-06-14','Estudio Jurídico Custidiano');
/*!40000 ALTER TABLE `empresas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `historiales_altas_clientes`
--

DROP TABLE IF EXISTS `historiales_altas_clientes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `historiales_altas_clientes` (
  ...
  KEY `id_ctactecliente_cliente` (`id_ctactecliente_cliente`),
  KEY `id_actividad_cliente` (`id_actividad_cliente`),
  CONSTRAINT `id_actividad_cliente` FOREIGN KEY (`id_actividad_cliente`) REFERENCES `actividades_usuarios` (`id_actividad`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `id_ctactecliente_cliente` FOREIGN KEY (`id_ctactecliente_cliente`) REFERENCES `ctasctescliente` (`id_ctactecliente`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historiales_altas_clientes`
--

LOCK TABLES `historiales_altas_clientes` WRITE;
/*!40000 ALTER TABLE `historiales_altas_clientes` DISABLE KEYS */;
INSERT INTO `historiales_altas_clientes` VALUES (5,136,14,'TRANSPORTE CLI/53');
/*!40000 ALTER TABLE `historiales_altas_clientes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `historiales_altas_planes_pagos`
--

DROP TABLE IF EXISTS `historiales_altas_planes_pagos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `historiales_altas_planes_pagos` (
  `id_historial_alta_plan_pago` int NOT NULL AUTO_INCREMENT,
  `id_ctactecliente_plan_pago` int DEFAULT NULL,
  `fk_plan_pago` int DEFAULT NULL,
  `id_actividad_plan_pago` int DEFAULT NULL,
  `concepto` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id_historial_alta_plan_pago`),
  KEY `id_ctactecliente_plan_pago` (`id_ctactecliente_plan_pago`),
  KEY `fk_plan_pago` (`fk_plan_pago`),
  KEY `id_actividad_alta_pago` (`id_actividad_plan_pago`),
  CONSTRAINT `fk_plan_pago` FOREIGN KEY (`fk_plan_pago`) REFERENCES `planes_pagos` (`id_plan_pago`),
  CONSTRAINT `id_actividad_alta_pago` FOREIGN KEY (`id_actividad_plan_pago`) REFERENCES `actividades_usuarios` (`id_actividad`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `id_ctactecliente_plan_pago` FOREIGN KEY (`id_ctactecliente_plan_pago`) REFERENCES `ctasctescliente` (`id_ctactecliente`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historiales_altas_planes_pagos`
--

LOCK TABLES `historiales_altas_planes_pagos` WRITE;
/*!40000 ALTER TABLE `historiales_altas_planes_pagos` DISABLE KEYS */;
INSERT INTO `historiales_altas_planes_pagos` VALUES (1,NULL,58,15,'PLAN PAGO /58');
/*!40000 ALTER TABLE `historiales_altas_planes_pagos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `historiales_proveedores`
--

DROP TABLE IF EXISTS `historiales_proveedores`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `historiales_proveedores` (
  ...
  PRIMARY KEY (`id_historial_proveedor`),
  KEY `fk_proveedor` (`fk_proveedor`),
  KEY `id_actividad_proveedor` (`id_actividad_proveedor`),
  CONSTRAINT `fk_proveedor` FOREIGN KEY (`fk_proveedor`) REFERENCES `proveedores` (`id_proveedor`),
  CONSTRAINT `id_actividad_proveedor` FOREIGN KEY (`id_actividad_proveedor`) REFERENCES `actividades_usuarios` (`id_actividad`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historiales_proveedores`
--

LOCK TABLES `historiales_proveedores` WRITE;
/*!40000 ALTER TABLE `historiales_proveedores` DISABLE KEYS */;
INSERT INTO `historiales_proveedores` VALUES (3,8,13);
/*!40000 ALTER TABLE `historiales_proveedores` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `historiales_recibos`
--

DROP TABLE IF EXISTS `historiales_recibos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `historiales_recibos` (
  `id_historial_recibo` int NOT NULL AUTO_INCREMENT,
  `id_ctactecliente_recibo` int DEFAULT NULL,
  `fk_recibo` int DEFAULT NULL,
  `id_actividad_recibo` int DEFAULT NULL,
  `concepto` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id_historial_recibo`),
  KEY `id_ctactecliente_recibo` (`id_ctactecliente_recibo`),
  KEY `fk_recibo` (`fk_recibo`),
  KEY `id_actividad_recibo` (`id_actividad_recibo`),
  CONSTRAINT `fk_recibo` FOREIGN KEY (`fk_recibo`) REFERENCES `recibos` (`id_recibo`),
  CONSTRAINT `id_actividad_recibo` FOREIGN KEY (`id_actividad_recibo`) REFERENCES `actividades_usuarios` (`id_actividad`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `id_ctactecliente_recibo` FOREIGN KEY (`id_ctactecliente_recibo`) REFERENCES `ctasctescliente` (`id_ctactecliente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historiales_recibos`
--

LOCK TABLES `historiales_recibos` WRITE;
/*!40000 ALTER TABLE `historiales_recibos` DISABLE KEYS */;
/*!40000 ALTER TABLE `historiales_recibos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `historiales_sucursales`
--

DROP TABLE IF EXISTS `historiales_sucursales`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `historiales_sucursales` (
  `id_historial_sucursal` int NOT NULL AUTO_INCREMENT,
  `fk_sucursal` int DEFAULT NULL,
  `id_actividad_sucursal` int DEFAULT NULL,
  PRIMARY KEY (`id_historial_sucursal`),
  KEY `fk_sucursal` (`fk_sucursal`),
  KEY `id_actividad_sucursal` (`id_actividad_sucursal`),
  CONSTRAINT `fk_sucursal` FOREIGN KEY (`fk_sucursal`) REFERENCES `sucursales` (`id_sucursal`),
  CONSTRAINT `id_actividad_sucursal` FOREIGN KEY (`id_actividad_sucursal`) REFERENCES `actividades_usuarios` (`id_actividad`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historiales_sucursales`
--

LOCK TABLES `historiales_sucursales` WRITE;
/*!40000 ALTER TABLE `historiales_sucursales` DISABLE KEYS */;
/*!40000 ALTER TABLE `historiales_sucursales` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `importes` (
  `id_importe` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `id_cuota` FOREIGN KEY (`id_cuota`) REFERENCES `cuotas` (`id_cuota`),
  CONSTRAINT `id_medio_pago` FOREIGN KEY (`id_medio_pago`) REFERENCES `medios_pagos` (`id_medio_pago`),
  CONSTRAINT `importes_ibfk_1` FOREIGN KEY (`id_cuota`) REFERENCES `cuotas` (`id_cuota`)
...
LOCK TABLES `importes` WRITE;
/*!40000 ALTER TABLE `importes` DISABLE KEYS */;
/*!40000 ALTER TABLE `importes` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `localidades` (
  ...
  CONSTRAINT `id_provincia` FOREIGN KEY (`id_provincia`) REFERENCES `provincias` (`id`)
...
INSERT INTO `medios_pagos` VALUES (1,'2022-05-05','Efectivo',1),(2,'2022-05-05','Transferencia',2);
/*!40000 ALTER TABLE `medios_pagos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `planes_pagos`
--

DROP TABLE IF EXISTS `planes_pagos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `planes_pagos` (
  ...
  KEY `id_tipo_interes` (`id_tipo_interes`),
  KEY `id_proveedor` (`id_proveedor`),
  CONSTRAINT `id_proveedor` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedores` (`id_proveedor`),
  CONSTRAINT `id_tipo_interes` FOREIGN KEY (`id_tipo_interes`) REFERENCES `tipos_intereses` (`id_tipo_interes`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `planes_pagos`
--

LOCK TABLES `planes_pagos` WRITE;
/*!40000 ALTER TABLE `planes_pagos` DISABLE KEYS */;
INSERT INTO `planes_pagos` VALUES (58,'2022-06-20','19792.8','12',1649.4,NULL,1,12000,4,125,3,0,0,8,1,0,0,'Dr. José Custidiano','1000/22');
/*!40000 ALTER TABLE `planes_pagos` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `preguntas` VALUES (1,'Mejor amigo/a de la infancia'),(2,'Lugar de nacimiento de la madre'),(3,'Profesor favorito'),(4,'Personaje histórito favorito'),(5,'Ocupación del abuelo');
...
CREATE TABLE `proveedores` (
  ...
  KEY `id_localidad4` (`id_localidad4`),
  KEY `id_tipodocumento1` (`id_tipodocumento1`),
  CONSTRAINT `id_localidad4` FOREIGN KEY (`id_localidad4`) REFERENCES `localidades` (`id`),
  CONSTRAINT `id_tipodocumento1` FOREIGN KEY (`id_tipodocumento1`) REFERENCES `tipos_documentos` (`id_tipo_documento`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `proveedores` VALUES (8,'Credibel','Av. Italia 123','3624400001','','3624400002','','','',429,5,1,'20100000011');
...
CREATE TABLE `recibos` (
  ...
  CONSTRAINT `id_concepto` FOREIGN KEY (`id_concepto`) REFERENCES `conceptos` (`id_concepto`)
...
--
-- Table structure for table `responsables_iva`
--

DROP TABLE IF EXISTS `responsables_iva`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `responsables_iva`
--

LOCK TABLES `responsables_iva` WRITE;
/*!40000 ALTER TABLE `responsables_iva` DISABLE KEYS */;
INSERT INTO `responsables_iva` VALUES (1,'IVA Responsable Inscripto'),(2,'IVA Responsable no Inscripto'),(3,'IVA no Responsable'),(4,'IVA Sujeto Exento'),(5,'Consumidor Final'),(6,'Responsable Monotributo'),(7,'Sujeto no Categorizado'),(8,'Proveedor del Exterior'),(9,'Cliente del Exterior'),(10,'IVA Liberado – Ley Nº 19.640'),(11,'IVA Responsable Inscripto – Agente de Percepción'),(12,'Pequeño Contribuyente Eventual'),(13,'Monotributista Social'),(14,'Pequeño Contribuyente Eventual Social'),(15,'IGNORAR');
/*!40000 ALTER TABLE `responsables_iva` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `roles` VALUES (1,'Administrador'),(2,'Sucursal'),(3,'Usuario');
...
CREATE TABLE `sucursales` (
  ...
  KEY `id_localidad2` (`id_localidad2`),
  CONSTRAINT `id_empresa` FOREIGN KEY (`id_empresa`) REFERENCES `empresas` (`id_empresa`),
  CONSTRAINT `id_localidad2` FOREIGN KEY (`id_localidad2`) REFERENCES `localidades` (`id`)
...
INSERT INTO `tipos_documentos` VALUES (1,'D.N.I.'),(2,'L.C.'),(3,'L.E.'),(4,'C.I.'),(5,'CUIL'),(6,'CUIT');
/*!40000 ALTER TABLE `tipos_documentos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tipos_intereses`
--

DROP TABLE IF EXISTS `tipos_intereses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `tipos_intereses`
--

LOCK TABLES `tipos_intereses` WRITE;
/*!40000 ALTER TABLE `tipos_intereses` DISABLE KEYS */;
INSERT INTO `tipos_intereses` VALUES (1,'Interés Fijo'),(2,'Interés Sobre Saldos');
/*!40000 ALTER TABLE `tipos_intereses` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `usuarios` VALUES (10,'test','test','2022-06-04',5,'Radio','$2a$10$vODIuzjx3U3ct64IBVYPtuz3p2hCCr/tEIaAlUMe18.ytkx9.nx7y'),(11,'1234','administrador','2022-06-14',4,'San Martin','$2a$10$/oFekBQbJp6SSnD4rQj0medJn5qEMz8d8jl/dU.j9NvZIFIjAvtou');
...
-- Dump completed on 2022-06-21 11:56:56
